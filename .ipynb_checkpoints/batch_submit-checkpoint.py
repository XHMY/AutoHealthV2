...
def main():
    ...
    headers = {
        ...
        'cookie': f'JSESSIONID={args.j}',
    }

    last_card_data = requests.post('https://work.zcst.edu.cn/default/work/jlzh/jkxxtb/com.sudytech.work.jlzh.jkxxtb.jkxxcj.queryYear.biz.ext', headers=headers, data={}).json()
    print("last_card_data", last_card_data)
